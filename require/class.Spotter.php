...
class Spotter
{
	public $aircraft_correct_icaotype = array(
		'CL64' => 'CL60',
		'F9LX' => 'F900',
		'K35T' => 'K35R',
		'F5EX' => 'FA50',
	...
	public function getSquawkUsage($squawk = '', $country = 'FR')
	{
		...
		$squawk = filter_var($squawk, 513);
		$country = filter_var($country, 513);
	...
	public function getAirportIcao($airport_iata = '')
	{
		...
		$airport_iata = filter_var($airport_iata, 513);
	...
	public function getAirportDistance($airport_icao, $latitude, $longitude)
	{
		...
		$airport_icao = filter_var($airport_icao, 513);
	...
	public function getAllAirlineInfo($airline_icao, $fromsource = NULL)
	{
		...
		$airline_icao = strtoupper(filter_var($airline_icao, 513));
	...
	public function getAllAirlineInfoByName($airline_name, $fromsource = NULL)
	{
		...
		if (isset($globalUseRealAirlines) && $globalUseRealAirlines) $fromsource = NULL;
		$airline_name = strtolower(filter_var($airline_name, 513));
	...
	{
		$aircraft_type = filter_var($aircraft_type, 513);
	...
	{
		$aircraft_modes = filter_var($aircraft_modes, 513);
		$source_type = filter_var($source_type, 513);
	...
	{
		$operator = filter_var($operator, 513);
...
//			$temp_array['aircraft_name'] = $row['aircraft_name'];
	...
	public function getAllAirlineNamesByAlliance($alliance, $forsource = NULL, $filters = array())
	{
		global $globalAirlinesSource, $globalVATSIM, $globalIVAO, $globalNoAirlines;
		if (isset($globalNoAirlines) && $globalNoAirlines) return array();
		$alliance = filter_var($alliance, 513);
		//$filter_query = $this->getFilter($filters,true,true);
		if (isset($globalAirlinesSource) && $globalAirlinesSource != '') $forsource = $globalAirlinesSource;
		elseif (isset($globalVATSIM) && $globalVATSIM) $forsource = 'vatsim';
		elseif (isset($globalIVAO) && $globalIVAO) $forsource = 'ivao';
	 ...
	 */
	public function updateIdentSpotterData($ident = '', $flightaware_id = '', $fromsource = null, $sourcetype = null)
	{
	 ...
	 * @return String success or false
	 */
	public function updateInitialSpotterData($ident = '', $flightaware_id = '', $latitude = '', $longitude = '', $altitude = '', $altitude_real = '', $ground = false, $groundspeed = null, $date = '')
	{
		if ($groundspeed == '') $groundspeed = NULL;
