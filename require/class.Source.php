...
class Source
{
	...
	*/
	...
	{
		// SQL query to update the description based on name, source, and optional source_id
	...
	public function updateLocationByLocationID($location_id, $name, $latitude, $longitude, $altitude, $city, $country, $source, $logo = 'antenna.png', $type = '', $source_id = 0, $last_seen = '', $description = '')
	{
		// Set a default value for last_seen if not provided
		if ($last_seen == '') $last_seen = date('Y-m-d H:i:s');

		// SQL query to update location information based on location_id, source, and optional source_id
