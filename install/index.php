...
if (!isset($_SESSION['install']) && !isset($_SESSION['identified'])) {
	...
	$password = filter_input(INPUT_POST, 'password', 513, FILTER_FLAG_NO_ENCODE_QUOTES);
		...
		<form method="post" class="form-horizontal">
			...
			<fieldset id="coverage">
				...
				<p>
					...
					<input type="number" name="livezoom" id="livezoom" value="<?php if (isset($globalLiveZoom)) print $globalLiveZoom;
																				else print '9'; ?>" />
				</p>
				<p>
...
-->
			...
			<fieldset id="optional">
				...
				<p>
					...
					<input type="text" name="map3dtileset" id="map3dtileset" value="<?php if (isset($globalMap3DTiles) && $globalMap3DTiles) {
																						print $globalMap3DTiles;
																					} ?>" />
				...
				<p>
					...
					<input type="text" name="corsproxy" id="corsproxy" value="<?php if (isset($globalCORSproxy)) print $globalCORSproxy;
																				else print 'https://galvanize-cors-proxy.herokuapp.com/' ?>" />
...
-->
			...
			-->
				...
				<p>
					...
					<input type="number" name="archivemonths" id="archivemonths" value="<?php if (isset($globalArchiveMonths)) print $globalArchiveMonths;
																						else echo '1'; ?>" />
				...
				<p>
					...
					<input type="number" name="archivekeepmonths" id="archivekeepmonths" value="<?php if (isset($globalArchiveKeepMonths)) print $globalArchiveKeepMonths;
																								else echo '1'; ?>" />
				<p class="help-block">0 to disable</p>
				</p>
				<p>
					<label for="archivekeeptrackmonths">Keep flights track data for xx months in archive</label>
					<input type="number" name="archivekeeptrackmonths" id="archivekeeptrackmonths" value="<?php if (isset($globalArchiveKeepTrackMonths)) print $globalArchiveKeepTrackMonths;
																											else echo '1'; ?>" />
				...
				<div id="cronends">
					...
					<input type="number" name="cronend" id="cronend" value="<?php if (isset($globalCronEnd)) print $globalCronEnd;
																			else print '0'; ?>" />
...
-->
				...
				<p>
					...
					<input type="number" name="refresh" id="refresh" value="<?php if (isset($globalLiveInterval)) echo $globalLiveInterval;
																			else echo '200'; ?>" />
				</p>
				<p>
					<label for="maprefresh">Live map refresh (in seconds)</label>
					<input type="number" name="maprefresh" id="maprefresh" value="<?php if (isset($globalMapRefresh)) echo $globalMapRefresh;
																					else echo '30'; ?>" />
				</p>
				<p>
					<label for="mapidle">Map idle timeout (in minutes)</label>
					<input type="number" name="mapidle" id="mapidle" value="<?php if (isset($globalMapIdleTimeout)) echo $globalMapIdleTimeout;
																			else echo '30'; ?>" />
				<p class="help-block">0 to disable</p>
				</p>
				<p>
					<label for="minfetch">HTTP/file source fetch every xxx seconds</label>
					<input type="number" name="minfetch" id="minfetch" value="<?php if (isset($globalMinFetch)) echo $globalMinFetch;
																				else echo '20'; ?>" />
				</p>
				<p>
				...
				<p>
					...
					<input type="number" name="closestmindist" id="closestmindist" value="<?php if (isset($globalClosestMinDist)) echo $globalClosestMinDist;
																							else echo '50'; ?>" />
				</p>
				<br />
				<p>
				...
				?>
					...
					<p>
						...
						<input type="color" name="aircrafticoncolor" id="aircrafticoncolor" value="#<?php if (isset($globalAircraftIconColor)) echo $globalAircraftIconColor;
																									else echo '1a3151'; ?>" />
					</p>
					<br />
					<p>
						<label for="marineiconcolor">Color of marine icon on map</label>
						<input type="color" name="marineiconcolor" id="marineiconcolor" value="#<?php if (isset($globalMarineIconColor)) echo $globalMarineIconColor;
																								else echo '43d1d8'; ?>" />
					</p>
					<br />
					<p>
						<label for="trackericoncolor">Color of tracker icon on map</label>
						<input type="color" name="trackericoncolor" id="trackericoncolor" value="#<?php if (isset($globalTrackerIconColor)) echo $globalTrackerIconColor;
																									else echo '1a3151'; ?>" />
					</p>
					<br />
					<p>
						<label for="satelliteiconcolor">Color of satellite icon on map</label>
						<input type="color" name="satelliteiconcolor" id="satelliteiconcolor" value="#<?php if (isset($globalSatelliteIconColor)) echo $globalSatelliteIconColor;
																										else echo '1a3151'; ?>" />
					</p>
					<?php
				...
				<div class="range">
					<input type="range" name="airportzoom" id="airportzoom" value="<?php if (isset($globalAirportZoom)) echo $globalAirportZoom;
																					else echo '7'; ?>" />
					<output id="range"><?php if (isset($globalAirportZoom)) echo $globalAirportZoom;
										else echo '7'; ?></output>
				</div>
				</p>
				<br />
...
if (isset($_POST['dbtype'])) {
	$installpass = filter_input(INPUT_POST, 'installpass', 513);
	$settings = array_merge($settings, array('globalInstallPassword' => $installpass));

	$dbtype = filter_input(INPUT_POST, 'dbtype', 513);
	$dbroot = filter_input(INPUT_POST, 'dbroot', 513);
	$dbrootpass = filter_input(INPUT_POST, 'dbrootpass', 513);
	$dbname = filter_input(INPUT_POST, 'dbname', 513);
	$dbuser = filter_input(INPUT_POST, 'dbuser', 513);
	$dbuserpass = filter_input(INPUT_POST, 'dbuserpass', 513);
	$dbhost = filter_input(INPUT_POST, 'dbhost', 513);
	$dbport = filter_input(INPUT_POST, 'dbport', 513);
	...
	*/
	...
	$sitename = filter_input(INPUT_POST, 'sitename', 513);
	$siteurl = filter_input(INPUT_POST, 'siteurl', 513);
	$timezone = filter_input(INPUT_POST, 'timezone', 513);
	$language = filter_input(INPUT_POST, 'language', 513);
	$settings = array_merge($settings, array('globalName' => $sitename, 'globalURL' => $siteurl, 'globalTimezone' => $timezone, 'globalLanguage' => $language));

	$mapprovider = filter_input(INPUT_POST, 'mapprovider', 513);
	$mapboxid = filter_input(INPUT_POST, 'mapboxid', 513);
	$mapboxtoken = filter_input(INPUT_POST, 'mapboxtoken', 513);
	$googlekey = filter_input(INPUT_POST, 'googlekey', 513);
	$bingkey = filter_input(INPUT_POST, 'bingkey', 513);
	$openweathermapkey = filter_input(INPUT_POST, 'openweathermapkey', 513);
	$mapquestkey = filter_input(INPUT_POST, 'mapquestkey', 513);
	$hereappid = filter_input(INPUT_POST, 'hereappid', 513);
	$hereappcode = filter_input(INPUT_POST, 'hereappcode', 513);
	$settings = array_merge($settings, array('globalMapProvider' => $mapprovider, 'globalMapboxId' => $mapboxid, 'globalMapboxToken' => $mapboxtoken, 'globalGoogleAPIKey' => $googlekey, 'globalBingMapKey' => $bingkey, 'globalHereappID' => $hereappid, 'globalHereappCode' => $hereappcode, 'globalMapQuestKey' => $mapquestkey, 'globalOpenWeatherMapKey' => $openweathermapkey));

	$latitudemax = filter_input(INPUT_POST, 'latitudemax', 513);
	$latitudemin = filter_input(INPUT_POST, 'latitudemin', 513);
	$longitudemax = filter_input(INPUT_POST, 'longitudemax', 513);
	$longitudemin = filter_input(INPUT_POST, 'longitudemin', 513);
	...
	$squawk_country = filter_input(INPUT_POST, 'squawk_country', 513);
	$settings = array_merge($settings, array('globalSquawkCountry' => $squawk_country));

	$latitudecenter = filter_input(INPUT_POST, 'latitudecenter', 513);
	$longitudecenter = filter_input(INPUT_POST, 'longitudecenter', 513);
	$settings = array_merge($settings, array('globalCenterLatitude' => $latitudecenter, 'globalCenterLongitude' => $longitudecenter));

	$acars = filter_input(INPUT_POST, 'acars', 513);
	if ($acars == 'acars') {
		$settings = array_merge($settings, array('globalACARS' => 'TRUE'));
	} else {
		$settings = array_merge($settings, array('globalACARS' => 'FALSE'));
	}
	$updatecheck = filter_input(INPUT_POST, 'updatecheck', 513);
	...
	$flightawareusername = filter_input(INPUT_POST, 'flightawareusername', 513);
	$flightawarepassword = filter_input(INPUT_POST, 'flightawarepassword', 513);
	$settings = array_merge($settings, array('globalFlightAwareUsername' => $flightawareusername, 'globalFlightAwarePassword' => $flightawarepassword));

	$sailawayemail = filter_input(INPUT_POST, 'sailawayemail', 513);
	$sailawaypass = filter_input(INPUT_POST, 'sailawaypassword', 513);
	$sailawaykey = filter_input(INPUT_POST, 'sailawaykey', 513);
	...
	//$sbshost = filter_input(INPUT_POST,'sbshost',513);
	...
	*/
	...
	$globalvatsim = filter_input(INPUT_POST, 'globalvatsim', 513);
	$globalva = filter_input(INPUT_POST, 'globalva', 513);
	$globalvm = filter_input(INPUT_POST, 'globalvm', 513);
	$globalivao = filter_input(INPUT_POST, 'globalivao', 513);
	$globalphpvms = filter_input(INPUT_POST, 'globalphpvms', 513);
	$globalvam = filter_input(INPUT_POST, 'globalvam', 513);
	$globalsbs = filter_input(INPUT_POST, 'globalsbs', 513);
	$globalaprs = filter_input(INPUT_POST, 'globalaprs', 513);
	$datasource = filter_input(INPUT_POST, 'datasource', 513);

	$globalaircraft = filter_input(INPUT_POST, 'globalaircraft', 513);
	if ($globalaircraft == 'aircraft') $settings = array_merge($settings, array('globalAircraft' => 'TRUE'));
	else $settings = array_merge($settings, array('globalAircraft' => 'FALSE'));
	$globaltracker = filter_input(INPUT_POST, 'globaltracker', 513);
	if ($globaltracker == 'tracker') $settings = array_merge($settings, array('globalTracker' => 'TRUE'));
	else $settings = array_merge($settings, array('globalTracker' => 'FALSE'));
	$globalmarine = filter_input(INPUT_POST, 'globalmarine', 513);
	if ($globalmarine == 'marine') $settings = array_merge($settings, array('globalMarine' => 'TRUE'));
	else $settings = array_merge($settings, array('globalMarine' => 'FALSE'));
	$globalsatellite = filter_input(INPUT_POST, 'globalsatellite', 513);
...
*/
	$acarshost = filter_input(INPUT_POST, 'acarshost', 513);
	$acarsport = filter_input(INPUT_POST, 'acarsport', FILTER_SANITIZE_NUMBER_INT);
	$settings = array_merge($settings, array('globalACARSHost' => $acarshost, 'globalACARSPort' => $acarsport));

	$bitly = filter_input(INPUT_POST, 'bitly', 513);
	$settings = array_merge($settings, array('globalBitlyAccessToken' => $bitly));

	$podaccuser = filter_input(INPUT_POST, 'podaccuser', 513);
	$settings = array_merge($settings, array('globalPODACCuser' => $podaccuser));
	$podaccpass = filter_input(INPUT_POST, 'podaccpass', 513);
	$settings = array_merge($settings, array('globalPODACCpass' => $podaccpass));

	$customcss = filter_input(INPUT_POST, 'customcss', 513);
	$settings = array_merge($settings, array('globalCustomCSS' => $customcss));

	$map3dtile = filter_input(INPUT_POST, 'map3dtileset', 513);
	$settings = array_merge($settings, array('globalMap3DTiles' => $map3dtile));

	$notamsource = filter_input(INPUT_POST, 'notamsource', 513);
	$settings = array_merge($settings, array('globalNOTAMSource' => $notamsource));
	$metarsource = filter_input(INPUT_POST, 'metarsource', 513);
	$settings = array_merge($settings, array('globalMETARurl' => $metarsource));

	$zoilatitude = filter_input(INPUT_POST, 'zoilatitude', 513);
	$zoilongitude = filter_input(INPUT_POST, 'zoilongitude', 513);
	...
	$archiveyear = filter_input(INPUT_POST, 'archiveyear', 513);
	...
	$britishairways = filter_input(INPUT_POST, 'britishairways', 513);
	$settings = array_merge($settings, array('globalBritishAirwaysKey' => $britishairways));
	$transavia = filter_input(INPUT_POST, 'transavia', 513);
	$settings = array_merge($settings, array('globalTransaviaKey' => $transavia));

	$lufthansakey = filter_input(INPUT_POST, 'lufthansakey', 513);
	$lufthansasecret = filter_input(INPUT_POST, 'lufthansasecret', 513);
	...
	$resetyearstats = filter_input(INPUT_POST, 'resetyearstats', 513);
...
*/
	...
	$mapoffline = filter_input(INPUT_POST, 'mapoffline', 513);
	...
	$globaloffline = filter_input(INPUT_POST, 'globaloffline', 513);
	...
	$mapsatellites = filter_input(INPUT_POST, 'mapsatellites', 513);
	...
	$map3ddefault = filter_input(INPUT_POST, 'map3ddefault', 513);
	...
	$one3dmodel = filter_input(INPUT_POST, 'one3dmodel', 513);
	...
	$map3dliveries = filter_input(INPUT_POST, 'map3dliveries', 513);
	...
	$map3dshadows = filter_input(INPUT_POST, 'map3dshadows', 513);
	...
	$estimation = filter_input(INPUT_POST, 'estimation', 513);
	...
	$fork = filter_input(INPUT_POST, 'fork', 513);
	if ($fork == 'fork') {
	...
	$colormap = filter_input(INPUT_POST, 'colormap', 513);
	...
	$unitdistance = filter_input(INPUT_POST, 'unitdistance', 513);
	$settings = array_merge($settings, array('globalUnitDistance' => $unitdistance));
	$unitaltitude = filter_input(INPUT_POST, 'unitaltitude', 513);
	$settings = array_merge($settings, array('globalUnitAltitude' => $unitaltitude));
	$unitspeed = filter_input(INPUT_POST, 'unitspeed', 513);
	$settings = array_merge($settings, array('globalUnitSpeed' => $unitspeed));

	$mappopup = filter_input(INPUT_POST, 'mappopup', 513);
	...
	$airportpopup = filter_input(INPUT_POST, 'airportpopup', 513);
	...
	$maphistory = filter_input(INPUT_POST, 'maphistory', 513);
	...
	$maptooltip = filter_input(INPUT_POST, 'maptooltip', 513);
	...
	$flightroute = filter_input(INPUT_POST, 'flightroute', 513);
	if ($flightroute == 'flightroute') {
		$settings = array_merge($settings, array('globalMapRoute' => 'TRUE'));
	} else {
		$settings = array_merge($settings, array('globalMapRoute' => 'FALSE'));
	}
	$flightremainingroute = filter_input(INPUT_POST, 'flightremainingroute', 513);
	...
	$allflights = filter_input(INPUT_POST, 'allflights', 513);
	...
	$groundaltitude = filter_input(INPUT_POST, 'groundaltitude', 513);
	...
	$mapmatchingsource = filter_input(INPUT_POST, 'mapmatchingsource', 513);
	$settings = array_merge($settings, array('globalMapMatchingSource' => $mapmatchingsource));
	$graphhopper = filter_input(INPUT_POST, 'graphhopper', 513);
